      ...
      <div class="container">
        ...
        <div class="cta-grid">
          <div class="cta-card">
            ...
            <a href="#email" class="btn btn-primary mt-sm">${t('cta.cards.c1.btn')}</a>
          </div>
          <div class="cta-card">
            <h3>${t('cta.cards.c2.title')}</h3>
            <p>${t('cta.cards.c2.text')}</p>
            <a href="#email" class="btn btn-outline mt-sm">${t('cta.cards.c2.btn')}</a>
          </div>
          <div class="cta-card">
            <h3>${t('cta.cards.c3.title')}</h3>
            <p>${t('cta.cards.c3.text')}</p>
            <a href="#email" class="btn btn-outline mt-sm">${t('cta.cards.c3.btn')}</a>
          </div>
        </div>
      </div>
    </section>
